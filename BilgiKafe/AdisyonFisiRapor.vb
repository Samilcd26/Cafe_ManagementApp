...
Public Class AdisyonFisiRapor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BilgiKafe.AdisyonFisiRapor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_AdisyonNoParam() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedAdisyonFisiRapor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AdisyonFisiRapor = New AdisyonFisiRapor()
        rpt.Site = Me.Site
        Return rpt
    End Function
